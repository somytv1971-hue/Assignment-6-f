...
export function CartIcon({ count }) {
  return (
    <div className="relative cursor-pointer">
      ...
      {count > 0 && (
        <span className="absolute -top-2 -right-2 bg-purple-400 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
          {count}
        </span>
      )}
    </div>
...
export function EmptyCartIllustration() {
  return (
    <svg
      className="w-24 h-24 text-purple-200 mb-4"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
